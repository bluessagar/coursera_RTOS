...
int main (int argc, char *argv[])
{
   int i=0;
    ...
    // syslog message 
    syslog(LOG_INFO, "[COURSE:1][ASSIGNMENT: 3]: Create 128 Threads\n");
   ...
   for(i=0;i<TH_COUNT;i++)
   {
    ...
    // syslog message 
    syslog(LOG_INFO, "[COURSE:1][ASSIGNMENT: 3]: Join all the 128 Threads\n");
    ...
    // syslog message 
    syslog(LOG_INFO, "[COURSE:1][ASSIGNMENT: 3]: Assignment Finished.\n");
